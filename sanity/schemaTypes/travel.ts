...
export const travelType = defineType({ name: "travel", title: "旅行记录", type: "document", fields: [
  ...
  defineField({ name: "body", title: "游记正文", type: "array", of: [{ type: "block" }, { type: "image", options: { hotspot: true } }] }),
  ...
  defineField({ name: "gallery", title: "旅行图片集", type: "array", of: [{ type: "image", options: { hotspot: true } }] }),
