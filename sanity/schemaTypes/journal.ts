...
export const journalType = defineType({ name: "journal", title: "日常分享", type: "document", fields: [
  ...
  defineField({ name: "body", title: "正文", type: "array", of: [{ type: "block" }, { type: "image", options: { hotspot: true }, fields: [{ name: "alt", title: "图片说明", type: "string" }, { name: "caption", title: "图片下方文字", type: "string" }] }] }),
  ...
  defineField({ name: "gallery", title: "图片集", type: "array", of: [{ type: "image", options: { hotspot: true }, fields: [{ name: "alt", title: "图片说明", type: "string" }, { name: "caption", title: "图片下方文字", type: "string" }] }] }),
